    ...
    return (
        <Card sx={{ maxWidth: 300, mr: 1 }}>
            <CardActionArea>
                ...
                />
                <CardContent sx={{ background: "linear-gradient(356deg, rgba(238,174,202,1) 0%, rgba(220,233,148,0.7482590448288691) 100%)" }}>
...
export default function OpenSource(props) {
    ...
    const toolInformation = [
        ...
        },
        {
            ...
            image: "https://pbs.twimg.com/profile_images/961052733510893568/wbWiekmv_400x400.jpg",
    ...
    return (
        <Box>
            ...
            <Box sx={{ display: 'flex', textAlign: 'justify', }}>
                {toolInformation.map((value) => <CardTool info={value} />)}
            </Box>
        </Box>
    );
}
